...
private:
    ...
    std::vector<unsigned long> etfBidVolumeHistory;
    std::vector<unsigned long> etfAskVolumeHistory;
    std::vector<unsigned long> futureBidVolumeHistory;
    std::vector<unsigned long> futureAskVolumeHistory;
